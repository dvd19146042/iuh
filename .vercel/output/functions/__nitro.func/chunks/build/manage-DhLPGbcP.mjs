import { defineComponent, toRef, computed, useSSRContext, ref, onMounted, onUnmounted, h as h$1, Fragment, watchEffect, watch, provide, unref, inject, getCurrentInstance, Teleport, reactive, shallowRef, normalizeClass, withAsyncContext, withCtx, createTextVNode, createVNode, isRef, toRaw, cloneVNode, nextTick, toValue, mergeProps, onServerPrefetch, resolveComponent, renderSlot, openBlock, createBlock, Transition, createCommentVNode } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { m as mergeConfig, j as appConfig, k as useUI, l as __nuxt_component_3$1, d as __nuxt_component_2$1, n as get, c as useRouter, e as arrow$1, _ as _export_sfc, i as fetchDefaults, f as asyncDataDefaults, g as useNuxtApp, h as createError } from './server.mjs';
import { u as useFormGroup, c as useId, _ as __nuxt_component_4, a as __nuxt_component_5, b as __nuxt_component_6 } from './Input-BDZCRnhR.mjs';
import { H as upperFirst, o as defu, I as hash$2 } from '../runtime.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrLooseContain, ssrGetDynamicModelProps, ssrRenderAttr, ssrRenderSlot, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { useVModel } from '@vueuse/core';
import { d as deleteUser, u as updateUser } from './user-BOMUv8Fh.mjs';
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-1e545a26"]]);
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s3, expose: h$2 }) {
  ...
  let t2 = ref(1), o2 = ref(null), y2 = ref(null), v2 = ref(null), m2 = ref(null), b2 = computed(() => i$3(f2)), E2 = computed(() => {
    ...
    for (let x2 of (void 0).querySelectorAll("body > *"))
      if (Number(x2 == null ? void 0 : x2.contains(o$1(o2))) ^ Number(x2 == null ? void 0 : x2.contains(o$1(m2))))
        return true;
    ...
    if (b2.value) {
      ...
      switch (e2.key) {
        ...
        case o.Escape:
          ...
          if (!o$1(t2.button) || (G = o$22.value) != null && G.activeElement && !((C = o$1(t2.button)) != null && C.contains(o$22.value.activeElement)))
            return;
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d2, { attrs: P$1, slots: s3, expose: h2 }) {
  ...
  h2({ el: o$22.panel, $el: o$22.panel }), onMounted(() => {
    ...
    var p, u2;
    if (!t2 || o$22.popoverState.value !== 0 || !o$22.panel)
      return;
  ...
  function a2(i2) {
    ...
    switch (i2.key) {
      case o.Escape:
        if (o$22.popoverState.value !== 0 || !o$1(o$22.panel) || y2.value && !((p = o$1(o$22.panel)) != null && p.contains(y2.value.activeElement)))
          return;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { pending, data: users, refresh } = ([__temp, __restore] = withAsyncContext(() => useLazyFetch("/api/users", "$GiByIa8ZCd")), __temp = await __temp, __restore(), __temp);
    const user = reactive({
      name: void 0,
      gender: void 0,
      email: void 0,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UTable, {
        ...
        "actions-data": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UPopover, { open: unref(open) }, {
              panel: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex gap-4 p-6"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UButton, { color: "gray" }, {
                  ...
                  _push3(ssrRenderComponent(_component_UButton, {
                    onClick: () => unref(deleteUser)(row._id).then(() => {
                      unref(refresh)();
                      open.value = false;
                    }),
                    color: "green"
                  ...
                  return [
                    createVNode("div", { class: "flex gap-4 p-6" }, [
                      createVNode(_component_UButton, { color: "gray" }, {
                        default: withCtx(() => [
                          createTextVNode("Cancel")
                        ]),
                        _: 1
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UButton, { color: "red" }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Delete`);
                      } else {
                  ...
                  return [
                    createVNode(_component_UButton, { color: "red" }, {
                      default: withCtx(() => [
                        createTextVNode("Delete")
                      ]),
                      _: 1
            ...
            return [
              createVNode("div", { class: "flex gap-4" }, [
                createVNode(_component_UPopover, { open: unref(open) }, {
                  panel: withCtx(() => [
                    createVNode("div", { class: "flex gap-4 p-6" }, [
                      createVNode(_component_UButton, { color: "gray" }, {
                        default: withCtx(() => [
      ...
      _push(ssrRenderComponent(_component_UModal, {
        modelValue: unref(isEdit),
        "onUpdate:modelValue": ($event) => isRef(isEdit) ? isEdit.value = $event : null
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=manage-DhLPGbcP.mjs.map
