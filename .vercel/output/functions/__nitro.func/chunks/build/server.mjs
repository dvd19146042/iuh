import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, useAttrs, computed, toValue, defineComponent, toRef, useSSRContext, provide, shallowReactive, h, inject, Suspense, nextTick, Transition, onUnmounted, unref, isRef, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, resolveComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createApp, effectScope, reactive, hasInjectionContext, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, isShallow, isReactive, toRaw, createSlots, renderList } from 'vue';
import { $ as $fetch, c as createError$1, m as defuFn, n as klona, o as defu, p as createDefu, q as hasProtocol, t as joinURL, v as parseURL, w as parseQuery, x as isEqual, y as createHooks, z as withQuery, A as isScriptProtocol, B as withTrailingSlash, C as withoutTrailingSlash, D as sanitizeStatusCode, E as isSamePath, F as toRouteMatcher, G as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./addUser-Ci-bl0Ma.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DajezfxO.mjs').then((m) => m.default || m)
  },
  {
    name: "manage",
    path: "/manage",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./manage-DhLPGbcP.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-D5uTDjSp.mjs').then((r) => r["default"] || r.default || r));
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$7]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BCWV3AYO.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CH2kiRaJ.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useToast as b, useRouter as c, __nuxt_component_2$1 as d, entry$1 as default, arrow as e, asyncDataDefaults as f, useNuxtApp as g, createError as h, fetchDefaults as i, appConfig as j, useUI as k, __nuxt_component_3 as l, mergeConfig as m, get as n, useInjectButtonGroup as o, input as p, looseToNumber as q, useAppConfig as r, resolveIconName as s, useHead as u };
